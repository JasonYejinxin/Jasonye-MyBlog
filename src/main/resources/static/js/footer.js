...
document.writeln("				<span>Email：jason.jinxinye@gmail.com</span>");
document.writeln("				<span>Linkedin：https://www.linkedin.com/in/jinxin-ye-765122201</span>");
document.writeln("				<span>Github：https://github.com/JasonYejinxin</span>");
document.writeln("			</div>");
document.writeln("			<div id=\'rightContent\'>");
document.writeln("				<div id=\'footIcon\'>");
document.writeln("					<img id=\'logo\' src=\'img/logo.jpeg\' />");
document.writeln("				</div>");
document.writeln("");
document.writeln("				<div id=\'copyright\'>");
document.writeln("					Copyright @ JasonYe, Design @JasonYe, 2022");
document.writeln("				</div>");
document.writeln("			</div>");
